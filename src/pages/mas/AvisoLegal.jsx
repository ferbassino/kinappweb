  ...
  return (
    <div className="text-justify">
      <h1 className="my-5 text-center">
        <strong>TÉRMINOS Y CONDICIONES DE USO DEL SITIO</strong>
      </h1>
      <h3 className="my-3">Versión vigente: 11 de marzo de 2024. </h3>
      <h2 className="mt-5">
        <strong>1- KINAPP</strong>
      </h2>
      <p className="my-2">
        kinApp es una aplicación web que ofrece servicios tecnológicos
        vinculados con el análisis del movimiento corporal.
      </p>
      <p className="my-2">
        Los servicios que ofrece kinApp en el sitio www.kinappweb.vercel.com y
        sus aplicaciones móviles están diseñados para formar un ecosistema que
        permita a las personas realizar análisis del movimiento humano,
        midiéndolo, analizándolo y guardándolo, si el usuario lo desea, en una
        base de datos.
      </p>

      <h2 className="mt-5">
        <strong>2- TÉRMINOS Y CONDICIONES</strong>
      </h2>

      <p className="my-2">
        Estos términos y condiciones y los anexos que explican los servicios del
        Ecosistema kinApp (de ahora en más: “Términos y Condiciones”) regulan la
        relación entre kinApp y las personas que usan sus servicios (“Personas
        Usuarias”).
      </p>
      <p className="my-2">
        Las Personas Usuarias aceptan estos Términos y Condiciones desde el
        momento en que se registran en el Sitio y usan el Ecosistema kinApp.
      </p>
      <p className="my-2">
        ...
        Ecosistema kinApp. El plazo será de 2 días hábiles en caso de que
        tengamos que actualizar las tarifas de nuestros servicios.
      </p>
      <p className="my-2">
        Las Personas Usuarias que no tengan obligaciones pendientes con kinApp
        podrán finalizar la relación con kinApp cancelando su cuenta.
      </p>
      ...
      <h2 className="mt-5">
        <strong>4- REGISTRO Y CUENTA</strong>
      </h2>
      <p className="my-2">
      ...
      <p className="my-2">
        La cuenta es personal, única e intransferible, es decir que bajo ningún
        concepto se podrá vender o ceder a otra persona. Se accede a ella con la
        clave personal de seguridad que haya elegido y que deberá mantener bajo
        estricta confidencialidad. En cualquier caso, la Persona Usuaria será la
        única responsable por las operaciones que se realicen en su cuenta. En
        caso de detectar un uso no autorizado de su cuenta, deberá notificar de
        forma inmediata y fehaciente a kinApp.
      </p>
      <p className="my-2">
      ...
      <p className="my-2">
        En kinApp hacemos un uso responsable de la información personal,
        ...
        nuestro Ecosistema kinApp.
      </p>
      <h2 className="mt-5">
        <strong>6- SANCIONES</strong>
      </h2>
      <p className="my-2">
      ...
      <p className="my-2">
        kinApp será responsable por cualquier defecto en la prestación de su
        servicio, en la medida en que le sea imputable y con el alcance previsto
        en las leyes vigentes.
      </p>
      <h2 className="mt-5">
        <strong>8-TARIFAS</strong>
      </h2>
      <p className="my-2">
        kinApp podrá cobrar por sus servicios y la Persona Usuaria se compromete
        a pagarlos a tiempo
      </p>
      <p className="my-2">
      ...
      <h2 className="mt-5">
        <strong>8- PROPIEDAD INTELECTUAL</strong>
      </h2>
      <p className="my-2">
        kinApp es propietarias de todos los derechos de propiedad intelectual
        sobre sus sitios, todo su contenido, servicios, productos, marcas,
        nombres comerciales, logos, diseños, imágenes, frases publicitarias,
        derechos de autor, dominios, programas de computación, códigos,
        desarrollos, software, bases de datos, información, tecnología, patentes
      ...
      <p className="my-2">
        Aunque kinApp otorga permiso para usar sus productos y servicios
        ...
        consentimiento previo y expreso de kinApp y/o sus sociedades vinculadas.
        En cualquier caso, los usuarios vendedores que usen dichos productos y
        servicios no podrán utilizar la Propiedad Intelectual de kinApp de una
        ...
        distintivo, que no resulte confundible con la marca kinApp.
      </p>
      <p className="my-2">
        Está prohibido usar nuestros productos o servicios para fines ilegales,
        ...
        o pérdidas a kinApp. La utilización de los productos y servicios de
        kinApp tampoco implica la autorización para usar propiedad intelectual
        de terceros que pueda estar involucrada, cuyo uso quedará bajo exclusiva
        responsabilidad del usuario. En caso que una Persona Usuaria o cualquier
        publicación infrinja la Propiedad Intelectual de kinApp o de terceros,
        kinApp podrá remover dicha publicación total o parcialmente, sancionar
        al usuario conforme a lo previsto en estos Términos y Condiciones y
        ejercer las acciones extrajudiciales y/o judiciales correspondientes.
      </p>
      ...
      <p className="my-2">
        La Persona Usuaria mantendrá indemne a kinApp así como a quienes la
        dirigen, suceden, administran, representan y/o trabajan en ellas, por
        cualquier reclamo administrativo o judicial iniciado por otras Personas
        Usuarias, terceros o por cualquier Organismo, relacionado con sus
        actividades en el Ecosistema kinApp. En virtud de esa responsabilidad,
        podrán realizar compensaciones, retenciones u otras medidas necesarias
        para la reparación de pérdidas, daños y perjuicios, cualquiera sea su
        naturaleza.
      </p>
      <h2>
      ...
      <p className="my-2">
        ...
        Términos y Condiciones y con el uso del sitio, kinApp con establece como
        domicilio El Payador 5165, Tres de Febrero, Provincia de Buenos Aires,
        Argentina
      </p>
    </div>
  );
