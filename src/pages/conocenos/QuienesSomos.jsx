          ...
          <div className="p-4 lg:w-1/2">
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              ...
              <div className="flex-grow sm:pl-8">
                ...
                <h3>Lic. Kinesiólogo fisiatra (UBA)</h3>
                <h3>Desarrollador web full stack (UTN)</h3>
                <p className="mb-4">
          ...
          <div className="p-4 lg:w-1/2">
            <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              ...
              <div className="flex-grow sm:pl-8">
                ...
                <h3>Lic. Kinesiólogo fisiatra (UBA)</h3>
                <h3>Residente del Hospital Pirovano, CABA, Argentina</h3>
                <p className="mb-4">
                  Con experiencia en análisis biomecánico participando en
                  equipos de trabajo a nivel nacional e internacional (Volare
                  Sport, camp Iten, Kenia)
                </p>
                <span className="inline-flex">
                  <a className="text-gray-500">
                    <svg
