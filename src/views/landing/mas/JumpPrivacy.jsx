import "./JumpPrivacy.css";
import Navbar from "../../../components/landing/header/Navbar";
import Footer from "../../../components/landing/footer/Footer";

export default function JumpPrivacy() {
  return (
    <>
      <header>
        <Navbar />
      ...
      <div className="privacy-container">
        <h1 className="privacy-title">Privacy Policy for Jump</h1>

        <p className="privacy-p">
          At Jump, one of our main priorities is the privacy of our visitors.
          This Privacy Policy document contains types of information that is
          collected and recorded by Jump and how we use it.
        </p>
        ...
        <h2 className="privacy-subtitle">Log Files</h2>

        <p className="privacy-p">
          Jump follows a standard procedure of using log files. These files log
          visitors when they use app. The information collected by log files
        ...
        <h2 className="privacy-subtitle">Our Advertising Partners</h2>
        ...
        <ul>
          <li>
            <p className="privacy-p">Google</p>
            <p className="privacy-p">
        ...
        <h2 className="privacy-subtitle">Privacy Policies</h2>

        <p className="privacy-p">
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of Jump.
        </p>

        <p className="privacy-p">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Beacons that are used in their respective
          advertisements and links that appear on Jump. They automatically
        ...
        <p className="privacy-p">
          Note that Jump has no access to or control over these cookies that are
          used by third-party advertisers.
        </p>

        <h2 className="privacy-subtitle">Third Party Privacy Policies</h2>

        <p className="privacy-p">
          Jump's Privacy Policy does not apply to other advertisers or websites.
        ...
        <h2 className="privacy-subtitle">Children's Information</h2>
